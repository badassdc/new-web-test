module.exports = {
    ...
    footer: {
        ...
        developedWith: 'Developed with ❤️ by clqu & YashJ-.',
        allServices: 'All services are online.',
        someServices: 'Some services are down.'
    },
    index: {
        title: 'The best giveaway bot on Discord.',
        description: 'By creating advanced giveaways with Custom Giveaways, you can improve your social media accounts and gain organic lift!',
        buttons: {
            dashboard: 'Dashboard',
            support: 'Support Server',
        ...
        features: {
            title: 'Why <span class="text-amber-500 font-bold">Custom Giveaways</span>',
            description: 'With Custom Giveaways, you can improve your social media accounts and get organic increases by creating advanced sweepstakes!',
            buttonText: 'Add to Discord',
            items: [
                 { icon: 'fal fa-star', title: 'Easily Create Conditional Giveaway', description: 'You can have the members of your dreams in a short time. You can get organic increase by opening conditional giveaway by following your social media accounts such as youtube, twitch, tiktok on Custom Giveaways. Why not try opening a raffle for more information?' },
        ...
        advanced: [
            { placement: "left", imageUrl: 'https://i.imgur.com/YY3hwTn.png', title: 'Grow your accounts', description: 'Develop and grow your accounts organically with Custom Giveaways.'},
            { placement: "right", imageUrl: 'https://i.imgur.com/5X0ha3F.png', title: 'Lock your giveaways', description: "Privately encrypt your giveaways with Custom Giveaways's lock system." },
    ...
    team: {
        ...
        description: 'You can find everyone who works and contributes <br> to Custom Giveaways. Many thanks to our team. <3',
        linkcordLang: 'en',
        noWidget: 'No Widget',
        roles: {
            'Founder': 'Founder',
    ...
    user: {
        ...
        connections: {
            title: 'Connections',
            description: 'You can manage social media accounts on Custom Giveaways here.',
            button: {
    ...
    dashboard: {
        ...
        auditLog: {
            title: 'Audit Log',
            description: 'Audit log of changes made to Custom Giveaways on this server can be seen here.',
            table: {
                user: 'User',
                date: 'Date',
                action: 'Action',
