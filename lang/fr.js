module.exports = {
  ...
  footer: {
    ...
    developedWith: "Développé avec ❤️ par clqu & YashJ-.",
  ...
  index: {
    ...
    description:
      "En créant des cadeaux avancés avec Custom Giveaways, vous pouvez améliorer vos comptes de médias sociaux et gagner en visibilité organique !",
    buttons: {
      dashboard: "Tableau de bord",
      support: "Serveur d'assistance",
    ...
    features: {
      title: 'Pourquoi <span class="text-amber-500 font-bold">Custom Giveaways</span>',
      description: 'Vous pouvez améliorer vos comptes de médias sociaux et obtenir une augmentation organique en créant des tirages au sort avancés avec Custom Giveaways!',
      buttonText: 'Ajouter au Discord',
      items: [
          { icon: 'fal fa-star', title: 'Créer facilement un cadeau conditionnel', description: "Vous pouvez avoir les membres de vos rêves en peu de temps. Vous pouvez obtenir une augmentation organique en ouvrant des tirages au sort conditionnels en suivant vos comptes de médias sociaux tels que youtube, twitch, tiktok sur Custom Giveaways. Pourquoi ne pas essayer d'ouvrir une tombola pour plus d'informations ?"},
  ...
  advanced: [
      { placement: "left", imageUrl: 'https://i.imgur.com/YY3hwTn.png', title: 'Développez vos comptes', description: 'Avec Custom Giveaways, vous pouvez développer vos comptes de manière organique.'},
      { placement: "right", imageUrl: 'https://i.imgur.com/5X0ha3F.png', title: 'Verrouillez vos tirages au sort', description: 'Chiffrez vos tirages au sort en privé avec le système de verrouillage de Custom Giveaways.' },
  ...
  team: {
    ...
    description:
      "Vous pouvez trouver tous ceux qui travaillent et contribuent <br> à Custom Giveaways. Un grand merci à notre équipe. <3",
    linkcordLang: "en",
  ...
  user: {
    ...
    connections: {
      title: "Connexions",
      description:
        "Vous pouvez gérer les comptes de médias sociaux sur Custom Giveaways ici.",
      button: {
  ...
  dashboard: {
    ...
    auditLog: {
      ...
      description:
        "Le journal d'audit des modifications apportées à Custom Giveaways sur ce serveur peut être consulté ici.",
      table: {
        user: "Utilisateur",
        date: "Date",
        action: "Action",
