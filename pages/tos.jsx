  ...
  return (
    <div>
      ...
      <a className={textClasses}>
        By accessing this Website, accessible from https://custom-giveaways.ml, you are
      ...
      <a className={textClasses}>
        ...
        on Custom Giveaways's Website for personal, non-commercial transitory viewing
      ...
      <ul className={listClasses}>
        ...
        <li>
          attempt to reverse engineer any software contained on Custom Giveaways's
          Website;
        </li>
        <li>
      ...
      <a className={textClasses}>
        All the materials on Custom Giveaways’s Website are provided "as is". Custom Giveaways makes
        no warranties, may it be expressed or implied, therefore negates all
        other warranties. Furthermore, Custom Giveaways does not make any representations
        ...
        to this Website. Features for which Custom Giveaways does not accept responsibility:
        <ul className={listClasses}>
      ...
      <a className={textClasses}>
        Custom Giveaways or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        Custom Giveaways’s Website, even if Custom Giveaways or an authorize representative of this
      ...
      <a className={textClasses}>
        The materials appearing on Custom Giveaways’s Website may include technical,
        typographical, or photographic errors. Custom Giveaways will not promise that any
        of the materials in this Website are accurate, complete, or current.
        Custom Giveaways may change the materials contained on its Website at any time
        without notice. Custom Giveaways does not make any commitment to update the
        materials.
      </a>
      ...
      <a className={textClasses}>
        Custom Giveaways has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by Custom Giveaways of the site. The use of
      ...
      <a className={textClasses}>
        Custom Giveaways may revise these Terms of Use for its Website at any time without
      ...
      <a className={textClasses}>
        Any claim related to Custom Giveaways's Website shall be governed by the laws of
