...
export default function Create({ isOpen, closeModal, mutateList }) {
    ...
    const addPartner = async () => {
        ...
        const _add = await axios.post(
            "https://custom-giveaways.ml/v1/partners/add?_token=" + 
        ...
        >
            ...
            >
                ...
                <div className="my-5">
                    ...
                    <input value={title} onChange={e => setTitle(e.target.value)} placeholder="Custom Giveaways" type="text" className="mb-2 text-white bg-black/10 py-2 px-4 rounded-xl focus:outline-none w-full border border-white/10 focus:border-amber-400 focus:text-amber-400 transform duration-200" spellCheck={false} autoComplete={false} />
                    ...
                    <input value={url} onChange={e => setUrl(e.target.value)} placeholder="https://custom-giveaways.ml" type="text" className="text-white bg-black/10 py-2 px-4 rounded-xl focus:outline-none w-full border border-white/10 focus:border-amber-400 focus:text-amber-400 transform duration-200" spellCheck={false} autoComplete={false} />
                </div>
