...
export default function Main({ $, boost, guild }) {
    ...
    const { data: _channels } = swr("https://custom-giveaways.ml/v1/guilds/" + (guild?.id || "#") + "/channels");
    ...
    const saveLog = async () => {
        ...
        const _save = await axios.post("https://custom-giveaways.ml/v1/guilds/" + (guild?.id || "#") + "/settings?_token=" + 
