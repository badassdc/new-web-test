  ...
  const connections = [
    {
      ...
      userCheck: user.connections["youtube"]
        ...
        : null,
      connectUrl: "https://custom-giveaways.ml/v1/connections/youtube/login",
      logoutUrl: "https://custom-giveaways.ml/v1/connections/youtube/logout",
    },
    {
      id: "github",
      ...
      connectUrl: "https://custom-giveaways.ml/v1/connections/github/login",
      logoutUrl: "https://custom-giveaways.ml/v1/connections/github/logout",
    },
    {
      id: "twitch",
      ...
      connectUrl: "https://custom-giveaways.ml/v1/connections/twitch/login",
      logoutUrl: "https://custom-giveaways.ml/v1/connections/twitch/logout",
    },
    {
      id: "twitter",
      ...
      userCheck: user.connections["twitter"]
        ...
        : null,
      connectUrl: "https://custom-giveaways.ml/v1/connections/twitter/login",
      logoutUrl: "https://custom-giveaways.ml/v1/connections/twitter/logout",
    }
  ];
  return (
    <div>
